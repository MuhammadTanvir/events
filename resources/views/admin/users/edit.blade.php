<x-layouts.app>
    ...
    <div class="mb-6 flex items-center text-sm">
        ...
        <span class="text-gray-500 dark:text-gray-400">{{ __('Edit Users') }}</span>
    </div>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form action="{{ route('users.update', $user) }}" method="POST" id="userForm">
                ...
                <div class="flex justify-end space-x-4 mt-6">
                    <a href="{{ route('users.index') }}"
                        class="bg-red-600 hover:bg-red-700 focus:ring-red-500 text-white font-medium py-2 px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors flex items-center justify-center cursor-pointer">
                        Cancel
                    </a>
                    <button type="submit"
