{{-- Flash Messages --}}
@if(session('success'))
    <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4 relative" role="alert">
...
@if(session('error'))
    <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4 relative" role="alert">
        <div class="flex items-center">
            <div class="flex-shrink-0">
...
@if(session('warning'))
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4 relative" role="alert">
        <div class="flex items-center">
            <div class="flex-shrink-0">
...
@if(session('info'))
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4 relative" role="alert">
        <div class="flex items-center">
            <div class="flex-shrink-0">
            ...
            <div class="ml-auto pl-3">
                <button type="button" class="inline-flex bg-blue-50 rounded-md p-1.5 text-blue-500 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-blue-50 focus:ring-blue-600" onclick="this.parentElement.parentElement.parentElement.style.display='none'">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                    </svg>
                </button>
